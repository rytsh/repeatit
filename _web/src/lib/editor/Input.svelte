...
<Code
  ...
  liveFunc={run}
>
  <div slot="title" class="inline-flex mx-2 px-2 border-l border-neutral-400">
    <select
      bind:value={$convertConfig.inputType}
      data-type="template"
      class="rounded-none block w-full bg-neutral-100 dark:bg-neutral-700 cursor-pointer"
      on:change={run}
    >
